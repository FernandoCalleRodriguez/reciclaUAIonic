...
export class AccionwebService {
    ...
    public obtenerAccionWebPorUsuario(id: number): Observable<AccionWeb[]> {
        return this.http.get<AccionWeb[]>(this.server + 'AccionWeb/BuscarAccionesWebPorUsuario?id_usuario=' + id, {headers: this.headers});
    }
